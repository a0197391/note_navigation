  ...
  return(
      <DrawerContentScrollView {...props}>
          <VStack ml={70} mb={2} mt={10} space={14}>
            ...
            <Text color={colorMode == "light" ? "dark-content" : "light-content"} style={styles.userStyle}> 某探險者</Text>
    ...
    >
      <Drawer.Screen 
        ...
        options={{
          ...
          drawerIcon: ({color}) => (
            <FontAwesome5 name="user-astronaut" color={color} size={30} style={styles.loginStyle}/>
          ),
        }}
      />
      <Drawer.Screen 
        ...
        options={{
          ...
          title: "探索設定",
          drawerIcon: ({color}) => (
            <Ionicons name="md-settings-outline" color={color} size={30} style={styles.setStyle}/>
          ),
        }}
      />
      ...
      <Drawer.Screen 
        ...
        options={{
          ...
          drawerIcon: ({color}) => (
            <FontAwesome5 name="star" color={color} size={30} style={styles.reviewStyle} />
          ),
        }}
      />
      ...
      <Drawer.Screen 
        ...
        options={{
          ...
          title: "探索說明書",
          drawerIcon: ({color}) => (
            <AntDesign name="book" color={color} size={30} style={styles.bookStyle}/>
          ),
        }}
      />
